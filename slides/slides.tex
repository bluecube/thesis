...
{
\logo{\includegraphics[height=1.5cm]{img/robot-dog.pdf}}
\begin{frame}{GPS -- Basic Principles}
    \begin{itemize}
        ...
        \end{itemize}
    \vspace{0.5cm}
    \centerline{\includegraphics[height=5cm]{img/pseudoranges.pdf}}
    \end{itemize}
\end{frame}
}

{
\logo{\includegraphics[height=1.5cm]{img/robot-dog2.pdf}}
\begin{frame}{GPS -- Basic Principles}
    \begin{itemize}
        \item Pseudorange
        \begin{itemize}
