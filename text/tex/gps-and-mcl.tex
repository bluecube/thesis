...
\questiontodo{better way to say this}
...
for example ultrasound ranging beacons are used in \cite{some-beacon-ref}\todo{Fix this ref!},
...
Firstly of all, the whole GPS operations work in ECEF coordinate system, meaning
