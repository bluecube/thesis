...
This chapter discusses using GPS data as an input to to the Monte Carlo localization,
...
Of these two we will consider mainly just correction inputs as GPS doesn't provide any
