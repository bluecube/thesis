...
\begin{equation}
\mathcal{N}(\mu = \SI{\clockDriftRateMu}{\meter}, \sigma = \SI{\clockDriftRateSigma}{\meter})
\end{equation}
for the receiver clock drift and 
\begin{equation}
\mathcal{N}(\mu = \SI{\residualClockDriftRateMu}{\meter}, \sigma = \SI{\residualClockDriftRateSigma}{\meter})
\end{equation}
...
\subsection{Sensor Model}
Sensor model of the individual measurements calculates the probability of the individual
...
For pseudoranges we chose the threshold of \SI{\pseudorangeThreshold}{\meter}} and
for velocity measurements \SI{\velocityThreshold}{\meter\per\second}.
