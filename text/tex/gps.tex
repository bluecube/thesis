...
count in atmosphere, \cite{navipedia-ionospheric}, it can be almost completely
eliminated when using multi frequency receivers.
Low cost single frequency receivers, are however forced to use less accurate
models of the ionosphere and ionospheric parameters transmitted in the
GPS navigation messages \cite{fyfe92}.
