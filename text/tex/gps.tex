...
modulo PRN code length possibly also phase and Doppler shift of the carrier wave.

Legacy GPS signals are transmitted on two frequencies, primary L1 (\SI{1575.42}{\mega\hertz}) and secondary L2 (\SI{1227.6}{\mega\hertz}).
