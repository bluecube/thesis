...
when measured on receiver on the ground.
To compensate this, satellite clock frequency is set to
\SI{10.22999999543}{\mega\hertz} before launch and the observed frequency on the
ground is \SI{10.23}{\mega\hertz} \cite{fyfe92}.
