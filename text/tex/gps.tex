...
\questiontodo{Is this OK?}
The document \cite{fyfe92} contains a specification of the GPS interface to user
segment describing many of the gory details of GPS system, however this is mostly
too low level to be of any use in this work.
...
modulated using this sequence, possibly mixed navigation messages (see further).
...
See chapter 3.3 of \cite{rizos99} for brief overview of navigation messages,
...
\Cref{fig:pseudorange} summarizes relations between times in a single pseudorange measurement.
...
The most famous effect of relativity is frequency shift of the satellite clock
