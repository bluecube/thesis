...
\todo{Should I add more detail to the definition?}
...
\end{equation}
but in practice the dependence is not linear (see \autoref{sec:wgs84_hdop_error}
and \autoref{fig:wgs84_hdop_error}).

\(2 \times \mathrm{DRMS}\) is often used as an approximation for a radius containing
\SI{95}{\percent} of measurements.

\section{Kalman Filters}
\todo{Do we need this section?}Kalman filters are often used in the GPS receivers to merge past
