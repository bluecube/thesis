...
\Cref{fig:mcl} contains -- somewhat artificial -- example of two
identical simulated robots on a chessboard.
Red lines show paths travelled by the robots and blue dots represent MCL samples.
Both of the robots use odometry data to estimate position, the robot on the left
